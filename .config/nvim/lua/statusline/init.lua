...
section.right[1]= {
  FileFormat = {
    provider = function()
      return utils.get_file_format_icon(
        string.lower(file_info.get_file_format())
      )
    end,
    condition = condition.buffer_not_empty,
    separator = ' ',
...
section.right[2] = {
  FileEncoding = {
    provider = function () return file_info.get_file_encode() end,
    condition = condition.buffer_not_empty,
    separator = ' | ',
...
section.right[4] = {
  Heart = {
    provider = function() return 'ﬦ ' end,
