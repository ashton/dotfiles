...
local lsp_get_diag = function(str)
  local severities = { warn = vim.diagnostic.severity.WARN, error = vim.diagnostic.severity.ERROR, info = vim.diagnostic.severity.INFO }
  local diagnostics = vim.diagnostic.get(0, { severity = severities[str:lower()]})
  local count = 0
