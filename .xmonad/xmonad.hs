...
myBorderWidth = 2
myWorkspaces    = ["\61612","\61705","\62150","\61501","\61564","\61899","\61947","\61635","\61502","\61872"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((controlMask .|. mod1Mask , xK_f), spawn $ "variety -f" )
  , ((controlMask .|. mod1Mask , xK_Right), spawn $ "variety -n" )
  , ((controlMask .|. mod1Mask , xK_Left), spawn $ "variety -p" )
  , ((controlMask .|. mod1Mask , xK_Up), spawn $ "variety --pause" )
  , ((controlMask .|. mod1Mask , xK_Down), spawn $ "variety --resume" )
